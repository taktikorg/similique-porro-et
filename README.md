<h1><img src="https://@taktikorg/similique-porro-et.org/img/@taktikorg/similique-porro-et-banner-logo.png" alt="Terser" width="400"></h1>
...
*note*: <s>You can support this project on patreon: [link]</s> **The Terser Patreon is shutting down in favor of opencollective**. Check out [PATRONS.md](https://github.com/taktikorg/similique-porro-et/blob/master/PATRONS.md) for our first-tier patrons.

Terser recommends you use RollupJS to bundle your modules, as that produces smaller code overall.

*Beautification* has been undocumented and is *being removed* from @taktikorg/similique-porro-et, we recommend you use [prettier](https://npmjs.com/package/prettier).

Find the changelog in [CHANGELOG.md](https://github.com/taktikorg/similique-porro-et/blob/master/CHANGELOG.md)



[npm-image]: https://img.shields.io/npm/v/@taktikorg/similique-porro-et.svg
[npm-url]: https://npmjs.org/package/@taktikorg/similique-porro-et
[downloads-image]: https://img.shields.io/npm/dm/@taktikorg/similique-porro-et.svg
[downloads-url]: https://npmjs.org/package/@taktikorg/similique-porro-et
[ci-image]: https://github.com/taktikorg/similique-porro-et/actions/workflows/ci.yml/badge.svg
[ci-url]: https://github.com/taktikorg/similique-porro-et/actions/workflows/ci.yml
[opencollective-contributors]: https://opencollective.com/@taktikorg/similique-porro-et/tiers/badge.svg
[opencollective-url]: https://opencollective.com/@taktikorg/similique-porro-et

Why choose @taktikorg/similique-porro-et?
------------------
...
**`@taktikorg/similique-porro-et`** is a fork of `uglify-es` that mostly retains API and CLI compatibility
...
From NPM for use as a command line app:
    ...
    npm install @taktikorg/similique-porro-et -g

From NPM for programmatic use:

    npm install @taktikorg/similique-porro-et
...
```
@taktikorg/similique-porro-et [input files] [options]
```
...
instance:
    ...
    @taktikorg/similique-porro-et input.js --compress ecma=2015,computed_props=false
...
a double dash to prevent input files being used as option arguments:
    ...
    @taktikorg/similique-porro-et --compress --mangle -- input.js
...
```
    ...
    --safari10                  Support non-standard Safari 10/11.
                                ...
                                By default `@taktikorg/similique-porro-et` will not work around
                                Safari 10/11 bugs.
...
For example:
    ...
    @taktikorg/similique-porro-et js/file1.js js/file2.js \
             -o foo.min.js -c -m \
...
Example:
    ...
    @taktikorg/similique-porro-et file.js -c toplevel,sequences=false
...
comma-separated list of names.  For example:
    ...
    @taktikorg/similique-porro-et ... -m reserved=['$','require','exports']
...
```
@taktikorg/similique-porro-et example.js -c -m --mangle-props regex=/_$/
```
...
```bash
$ @taktikorg/similique-porro-et example.js -c passes=2 -m --mangle-props
```
```javascript
...
```bash
$ @taktikorg/similique-porro-et example.js -c passes=2 -m --mangle-props reserved=[foo_,bar_]
```
```javascript
...
```bash
$ @taktikorg/similique-porro-et example.js -c passes=2 -m --mangle-props regex=/_$/
```
```javascript
...
```bash
$ @taktikorg/similique-porro-et example.js -c passes=2 -m --mangle-props regex=/_$/,reserved=[bar_]
```
```javascript
...
$ @taktikorg/similique-porro-et file1.js file2.js --mangle-props --name-cache /tmp/cache.json -o part1.js
$ @taktikorg/similique-porro-et file3.js file4.js --mangle-props --name-cache /tmp/cache.json -o part2.js
```
...
```
```bash
$ @taktikorg/similique-porro-et stuff.js --mangle-props keep_quoted -c -m
```
```javascript
...
```bash
$ @taktikorg/similique-porro-et stuff.js --mangle-props debug -c -m
```
```javascript
...
```javascript
const { minify } = require("@taktikorg/similique-porro-et");
```

Or,

```javascript
import { minify } from "@taktikorg/similique-porro-et";
```
...
<script src="https://cdn.jsdelivr.net/npm/@taktikorg/similique-porro-et/dist/bundle.min.js"></script>
```
...
- `undeclared` (default: `false`) - Mangle those names when they are accessed
  ...
  See [#397](https://github.com/taktikorg/similique-porro-et/issues/397) for more details.
...
and build your code like this:
    ...
    @taktikorg/similique-porro-et build/defines.js js/foo.js js/bar.js... -c
...
compress that:
    ...
    acorn file.js | @taktikorg/similique-porro-et -p spidermonkey -m -c
...
| @taktikorg/similique-porro-et@3.7.5 mangle=false, compress=false   | 316,600 |  85,245 |  0.82 |
| @taktikorg/similique-porro-et@3.7.5 mangle=true, compress=false    | 220,216 |  72,730 |  1.45 |
| @taktikorg/similique-porro-et@3.7.5 mangle=true, compress=true     | 212,046 |  70,954 |  5.87 |
...
```
@taktikorg/similique-porro-et file.js -m
```
...
Without this, all variable values will be `undefined`. See https://github.com/taktikorg/similique-porro-et/issues/1367 for more details.
<br/><br/>
...
https://www.npmjs.com/browse/depended/@taktikorg/similique-porro-et

### Replacing `uglify-es` with `@taktikorg/similique-porro-et` in a project using `yarn`

A number of JS bundlers and uglify wrappers are still using buggy versions
of `uglify-es` and have not yet upgraded to `@taktikorg/similique-porro-et`. If you are using `yarn`
you can add the following alias to your project's `package.json` file:

```js
  "resolutions": {
    "uglify-es": "npm:@taktikorg/similique-porro-et"
  }
```

to use `@taktikorg/similique-porro-et` instead of `uglify-es` in all deeply nested dependencies
...
Because users often don't control the call to `await minify()` or its arguments, Terser provides a `TERSER_DEBUG_DIR` environment variable to make @taktikorg/similique-porro-et output some debug logs.

These logs will contain the input code and options of each `minify()` call.

```bash
TERSER_DEBUG_DIR=/tmp/@taktikorg/similique-porro-et-log-dir command-that-uses-@taktikorg/similique-porro-et
ls /tmp/@taktikorg/similique-porro-et-log-dir
@taktikorg/similique-porro-et-debug-123456.log
```
...
```
> npx cross-env TERSER_DEBUG_DIR=/path/to/logs command-that-uses-@taktikorg/similique-porro-et
```

## Stack traces

In the @taktikorg/similique-porro-et CLI we use [source-map-support](https://npmjs.com/source-map-support) to produce good error stacks. In your own app, you're expected to enable source-map-support (read their docs) to have nice stack traces that will help you write good issues.
...
<a href="https://github.com/taktikorg/similique-porro-et/graphs/contributors"><img src="https://opencollective.com/@taktikorg/similique-porro-et/contributors.svg?width=890&button=false" /></a>

### Financial Contributors

Become a financial contributor and help us sustain our community. [[Contribute](https://opencollective.com/@taktikorg/similique-porro-et/contribute)]

#### Individuals

<a href="https://opencollective.com/@taktikorg/similique-porro-et"><img src="https://opencollective.com/@taktikorg/similique-porro-et/individuals.svg?width=890"></a>

#### Organizations

Support this project with your organization. Your logo will show up here with a link to your website. [[Contribute](https://opencollective.com/@taktikorg/similique-porro-et/contribute)]

<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/0/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/0/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/1/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/1/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/2/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/2/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/3/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/3/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/4/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/4/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/5/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/5/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/6/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/6/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/7/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/7/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/8/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/8/avatar.svg"></a>
<a href="https://opencollective.com/@taktikorg/similique-porro-et/organization/9/website"><img src="https://opencollective.com/@taktikorg/similique-porro-et/organization/9/avatar.svg"></a>
